                                    ...
                                    <div class="flex flex-wrap -m-2">
                                        ...
                                        <div class="p-2 w-full">
                                            <div class="relative">
                                                ...
                                                <input enabled type="radio" id="status" name="status" value="1" v-model="form.status">未キャンセル
                                                <input enabled type="radio" id="status" name="status" value="0" v-model="form.status">キャンセルする
                                            </div>
                                        </div>
                                        <div class="p-2 w-full">
                                            <div class="">
